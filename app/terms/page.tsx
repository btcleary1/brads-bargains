  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(160deg,#050814 0%,#0B1120 60%,#0f172a 100%)' }}>
      <div className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        {[
          ['1. Acceptance', "By creating an account and using AI FLIP, you agree to these terms. If you do not agree, do not use the service."],
          ['2. Description of Service', "AI FLIP is a deal discovery tool that uses eBay's official API to surface potentially profitable resale opportunities. We do not buy, sell, or broker any transactions. All purchases are made directly through eBay."],
          ...
          ['4. eBay Attribution', "Search results are powered by eBay's Browse API. Product listings, prices, and availability are owned by their respective eBay sellers. AI FLIP is not affiliated with or endorsed by eBay Inc."],
          ...
          ['9. Limitation of Liability', "AI FLIP is provided \"as is\" without warranties of any kind. We are not liable for any losses arising from use of this service, including but not limited to purchasing decisions made based on our deal scores or recommendations."],
