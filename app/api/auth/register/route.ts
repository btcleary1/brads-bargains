  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        html: `
<div style="font-family:-apple-system,sans-serif;max-width:520px;margin:0 auto;padding:32px 16px;background:#050814;">
  <div style="background:#0B1120;border-radius:20px;border:1px solid rgba(255,255,255,0.1);padding:36px;">
    ...
    <p style="margin:0 0 20px;font-size:15px;color:#9CA3AF;line-height:1.6;">
      Your Brad's Bargains account is ready. Find eBay deals at 70%+ off, track your flips, and get instant alerts when hot deals appear.
    </p>
