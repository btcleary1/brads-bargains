    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(160deg,#050814 0%,#0B1120 60%,#0f172a 100%)' }}>
      <div className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        {[
          ...
          ['2. How We Use Your Data', "Your email is used to authenticate your account and, if you opt in, to send daily deal digest emails. Your tracked deals and watchlist are used solely to personalize your experience within AI FLIP."],
          ...
          ['4. eBay Search Data', "Search queries you enter are passed to eBay's Browse API to retrieve listings. AI FLIP does not log your search history. eBay's own privacy policy governs any data eBay collects on their end."],
          ...
          ['9. Children', "AI FLIP is not directed at children under 13. We do not knowingly collect personal information from children."],
